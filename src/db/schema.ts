...
export const addIngredientTable = pgTable(
  ...
  (table) => {
    return {
      pk: primaryKey({
        columns: [table.ingredientId, table.customizedOrderId],
      }),
    };
  }
);
...
export const adminTable = pgTable("adminaccount", {
...
export const customizedOrderTable = pgTable("customized_order", {
...
export const drinkTypeTable = pgTable("drinktype", {
...
export const memberAccountTable = pgTable("memberaccount", {
...
export const orderTable = pgTable("memberorder", {
...
export const ingredientRestockTable = pgTable(
  ...
  (table) => {
    return {
      pk: primaryKey({
        columns: [table.date, table.ingredientId, table.branchId],
      }),
    };
  }
);
